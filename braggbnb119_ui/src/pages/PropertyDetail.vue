            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">State</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="State" type="text" placeholder="Enter State" v-model="propertyDetails.state"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Zip Code</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ZipCode" type="text" placeholder="Enter ZipCode" v-model="propertyDetails.zipCode"></input>
																		</div>
						</td>
														</tr>
															<tr> 
