						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="AvailableDates" type="text" placeholder="Enter AvailableDates" v-model="listingToAdd.availableDates"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Price</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Available Dates</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="AvailableDates" type="text" placeholder="Enter AvailableDates" v-model="listingDetails.availableDates"></input>
																		</div>
						</td>
														</tr>
